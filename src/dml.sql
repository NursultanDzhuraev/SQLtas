...
update people set age=1995 where id = 5;
insert into people (id, first_name, last_name, email, gender, age, language)
values (1, 'Aibek', 'aibek', 'aibek@gmail.com', 'Male', '20', 'kyrgyz');
insert into people (id, first_name, last_name, email, gender, age, language)
values (2, 'Baiel', 'baiel', '@gmail.com', 'Male', '21', 'kyrgyz');
insert into people (id, first_name, last_name, email, gender, age, language)
values (3, 'Asan', 'asan', '@gmail.com', 'Male', '22', 'kyrgyz');
insert into people (id, first_name, last_name, email, gender, age, language)
values (4, 'Nurbek', 'nurbek', '@gmail.com', 'Male', '23', 'kyrgyz');
insert into people (id, first_name, last_name, email, gender, age, language)
values (5, 'Almaz', 'almaz', '@gmail.com', 'Male', '24', 'kyrgyz');
INSERT INTO people (id, first_name, last_name, email, gender, age, language)
